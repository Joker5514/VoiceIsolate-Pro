...
const jsSource = tsSource
  ...
  // Remove type alias declarations (export type Foo = ...;)
  .replace(/export\s+type\s+\w+\s*=[^;]+;/g, '')
  // Remove generic type annotation on PRESETS: Record<..., ...>
  .replace(/:\s*Record<[^>]+>/g, '')
  // Remove simple named type annotations before = (e.g. : PresetId =)
...
describe('voiceisolate_presets — individual preset values', () => {
  describe('podcast-clean', () => {
    ...
    test('compAttack is 10', () => expect(preset.params.compAttack).toBe(10));
    test('gateThreshold is -48', () => expect(preset.params.gateThreshold).toBe(-48));
    test('gateAttack is 5', () => expect(preset.params.gateAttack).toBe(5));
  ...
  describe('voice-stream', () => {
    ...
    test('compAttack is 5', () => expect(preset.params.compAttack).toBe(5));
    test('gateThreshold is -44', () => expect(preset.params.gateThreshold).toBe(-44));
    test('gateAttack is 3', () => expect(preset.params.gateAttack).toBe(3));
  ...
  describe('aggressive-isolation', () => {
    ...
    test('compAttack is 15', () => expect(preset.params.compAttack).toBe(15));
    test('gateThreshold is -38', () => expect(preset.params.gateThreshold).toBe(-38));
    test('gateAttack is 8', () => expect(preset.params.gateAttack).toBe(8));
