...
the 4-layer `src/` module system, the security rules, and the list of
deliberately deleted legacy patterns (live-microphone ingestion, the
pipeline-orchestrator monolith, client-side auth, dev license stubs).
