      ...
      <main className="container mx-auto p-6">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-6">
          ...
          <div className="space-y-6">
            {/* Upload Zone */}
            <div
              className={`rounded-lg border-2 border-dashed p-12 text-center transition cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent ${
                isDragging
            ...
            >
              <div className="text-6xl mb-4" aria-hidden="true">{isDragging ? '📥' : '📁'}</div>
              <h3 className="text-xl font-semibold mb-2">
                {isDragging ? 'Release to upload' : 'Drop audio or video file'}
              </h3>
