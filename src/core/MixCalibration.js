...
export const LANDING_PRESETS = Object.freeze({
  'voice-clarity': buildPreset({
    noiseReductionSlider: 72,
    voiceLevelSlider: 108,
    eqLowSlider: -2,
    eqHighSlider: 0, // was +3 — high shelf caused piercing high-pitch residue
    eqLowMidSlider: 0,
    eqMidSlider: 1,
    eqHighMidSlider: 1,
    lowpassSlider: 14000,
  ...
  'podcast-warm': buildPreset({
    ...
    makeupGainSlider: 1.5,
    deEsserFreqSlider: 6500,
    deEsserAmountSlider: 10,
  }),
  'whisper-boost': buildPreset({
    noiseReductionSlider: 70,
    voiceLevelSlider: 125,
    eqLowSlider: -4,
    eqHighSlider: 0.5, // was +4 — drowned speech in high ring
    eqLowMidSlider: 1,
    eqMidSlider: 2,
    eqHighMidSlider: 1.5,
    highpassSlider: 100,
    lowpassSlider: 12000,
    compThresholdSlider: -32,
    compRatioSlider: 3.5,
    compAttackSlider: 10,
    compReleaseSlider: 150,
    compKneeSlider: 6,
    makeupGainSlider: 4,
    gateThresholdSlider: -66,
    gateRangeSlider: 0,
    gateAttackSlider: 3,
