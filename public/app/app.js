...
const SLIDERS = {
  ...
  sep: [
    ...
    { id:'crosstalkCancel', label:'Crosstalk Cancel', min:0, max:100, val:0, step:1, unit:'%', rt:false, desc:'Two-stage bleed removal. In the spectral domain, non-voice frames (VAD < 0.3) are attenuated by up to 80% × amount. In the time domain, a stereo M/S matrix subtracts a scaled copy of each channel from the other (L − g×R, R − g×L, g = amount × 0.5) to cancel physical mic bleed. Leave at 0 for mono sources; 30–50% suits multi-mic interviews; 60–100% for forensic speaker extraction.' },
  ],
  out: [
