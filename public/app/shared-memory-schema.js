...
export const HALF_BINS        = FFT_SIZE / 2 + 1;   // 2049
export const RENDER_QUANTUM   = 128;
export const FLAG_SLOTS       = 5;
export const SAB_HEADER_BYTES = Int32Array.BYTES_PER_ELEMENT * FLAG_SLOTS; // 20

// SAB byte sizes
export const INPUT_SAB_BYTES  = SAB_HEADER_BYTES
  + HALF_BINS * Float32Array.BYTES_PER_ELEMENT * 2   // mag + pha
  + HOP_SIZE  * Float32Array.BYTES_PER_ELEMENT;       // pcm

export const OUTPUT_SAB_BYTES = SAB_HEADER_BYTES
  + HALF_BINS * Float32Array.BYTES_PER_ELEMENT;       // mask

// Flag-slot indices (Int32Array offsets into the SAB header)
export const FLAG_WRITE_GEN  = 0;
export const FLAG_READ_GEN   = 1;
export const FLAG_CAPACITY   = 2;
export const FLAG_HALF_N     = 3;
export const FLAG_RESERVED   = 4;

// Float32 region offsets from byte 0 of the SAB
export const MAG_BYTE_OFFSET  = SAB_HEADER_BYTES;
export const PHA_BYTE_OFFSET  = SAB_HEADER_BYTES + HALF_BINS * 4;
export const PCM_BYTE_OFFSET  = SAB_HEADER_BYTES + HALF_BINS * 8;
export const MASK_BYTE_OFFSET = SAB_HEADER_BYTES;
 ...
 */
export function validateSharedMemoryLayout(inputSAB, outputSAB) {
...
/**
 * Create a correctly-sized inputSAB.
 * @returns {SharedArrayBuffer}
 */
export function createInputSAB() {
  return new SharedArrayBuffer(INPUT_SAB_BYTES);
}

/**
 * Create a correctly-sized outputSAB.
 * @returns {SharedArrayBuffer}
 */
export function createOutputSAB() {
  return new SharedArrayBuffer(OUTPUT_SAB_BYTES);
}

// CommonJS compatibility for test environments
