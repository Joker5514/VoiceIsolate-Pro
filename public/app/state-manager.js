 ...
 *
 * Usage:
 *   const { appState } = require('./state-manager.js'); // CJS
 *   import { appState } from './state-manager.js';      // ESM (if bundled)
...
(function (root, factory) {
  if (typeof module !== 'undefined' && module.exports) {
    ...
    root.StateManager = exports.StateManager;
    root.appState     = exports.appState;
  }
