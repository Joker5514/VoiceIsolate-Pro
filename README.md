...
<p align="center">
  <img src="https://img.shields.io/badge/version-v25.0.2-red" alt="v25.0.2">
...
|-------|------|----------------|---------|
| Android complete offline APK | `VoiceIsolate-Pro-android-debug.apk` | ~96.9 MB | **v25.0.2** on `latest` · rebuilt **2026-08-19T00:43Z** (`aa72a21`) |
| Windows NSIS installer | `VoiceIsolate-Pro-25.0.2-win-x64.exe` | ~138 MB | **v25.0.2** on `latest` · rebuilt **2026-08-19T00:43Z** (`aa72a21`) |
...
Native APK + EXE match current shell (desktop 88% #772, Android upload/freeze #770/#771) as of **2026-08-19T00:43Z**.
...
- **Native rebuild (2026-08-19T00:43Z)** — Android APK + Windows EXE from `aa72a21` (desktop 88% #772 + Android #770/#771)
