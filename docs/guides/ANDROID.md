...
| **UI freezes on open / Engineer** | Sideload APK ≥ **2026-08-18T23:15Z**: no boot mic prompt, one COOP reload/process, deferred media permission, debounced upload MutationObserver, mobile collapses rack sections. Uninstall old APK first. |
